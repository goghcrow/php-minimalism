#!/usr/bin/env php
<?php
namespace Minimalism\Novadump;

use Minimalism\Novadump\Terminal as T;
...
Usage: 
    ...
    novadump.php --app scrm-api --path /home/www/scrm-api/ --copy ./nova.log
...
//            $seqKey = "$srcIp:$srcPort";
//            if (isset($this->lastSeqLen[$seqKey])) {
//
//            } else {
//                $this->lastSeqLen[$seqKey] = $tcp["seq"];
//            }
